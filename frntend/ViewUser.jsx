...
const rows = [
  createData('Taran', 'Mens Yoga', '26-02-2024', '8.00 am', 4000),
  createData('Sanjay', 'Elders Yoga', '26-02-2024', '8.00 am', 4300),
  createData('Sundar', 'Children Yoga', '26-02-2024', '8.00 am', 6000),
  createData('Taran', 'Weightloss Yoga', '26-02-2024', '8.00 am', 4500),
  createData('Gokul', 'Women Yoga', '26-02-2024', '8.00 am', 3900),
];
      ...
      <Table sx={{ minWidth: 1000 }} aria-label="simple table">
        <TableHead>
          <TableRow style={{backgroundColor: 'lightgray'}}>
            ...
            <TableCell align="right">No of slots booked</TableCell>
